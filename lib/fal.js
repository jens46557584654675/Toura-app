...
const TOURA_BASE_PROMPT =
  'One single continuous cinematic shot with no cuts and no transitions: the camera glides smoothly from photo to photo, strictly in the given order, as if walking through the home. Use ONLY the rooms, furniture, materials and architecture visible in the source photos — never invent, add, remove or alter objects, spaces, layouts or decorations. Stay true to the real proportions, colors and lighting of the home. Steady gimbal-smooth camera at eye level, straight verticals, warm true-to-life color grading, natural real-estate pacing. No people, no on-screen text, no logos, no warping, no flickering, no hallucinated details. Deliver the clip completely silent: no music, no voice-over, no ambient audio.';
